...
<div class="container-fluid">
    <div id="ui-view">
        <div>
            <div class="row">
                <div class="col-lg-6">
                <form method="POST" action="{{route('update.plantilla',$plantilla->id)}}" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    <input type="text" class="form-control {{ $errors->has('titulo') ? ' is-invalid' : '' }}" placeholder="Titulo de la plantilla" name="titulo" value="{{$plantilla->titulo}}">
                                ...
                                <div class="col-lg-12 form-group">
                                    <textarea class="form-control {{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" placeholder="Descripcion de la plantilla">{{$plantilla->descripcion}}</textarea>
