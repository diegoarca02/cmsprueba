...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Edicion de enlace</li>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 form-group">
                                            <input type="text" class="form-control {{ $errors->has('enlace') ? ' is-invalid' : '' }}" placeholder="Enlace" name="enlace" value="{{$enlace->enlace}}">
